...
rep(
    ...
    '<img src="https://beyondwoundcare.com/choose.jpg" alt="Doctor with Patient" style="width:100%;height:148px;object-fit:cover;object-position:center top;border-radius:8px;display:block;margin-bottom:12px;box-shadow:0 4px 12px rgba(26,111,163,.2);">',
    'P1M – photo upgrade'
)
...
rep(
    ...
    '<h2 style="font-size:11.5pt;font-weight:900;color:var(--teal-dk);text-align:center;text-transform:uppercase;letter-spacing:.05em;margin-bottom:8px;" contenteditable="true">Beyond Wound Care Inc.</h2>',
    'P1M – name'
)
...
rep(
    ...
    '''          <div class="cta-box">
            ...
            <div class="cta-sub" contenteditable="true">Serving Illinois — covered by Medicare</div>
          </div>''',
    'P1R – CTA box'
)
...
rep(
    ...
    '<img src="https://beyondwoundcare.com/choose.jpg" alt="Why Choose Us" style="width:100%;height:128px;object-fit:cover;object-position:center top;border-radius:8px;display:block;margin-bottom:12px;box-shadow:0 4px 12px rgba(26,111,163,.2);">',
    'P2M – image'
)
...
rep(
    ...
    '<img src="https://beyondwoundcare.com/qualify.jpg" alt="Qualify" style="width:100%;height:78px;object-fit:cover;object-position:center;border-radius:7px;display:block;box-shadow:0 3px 10px rgba(26,111,163,.15);">',
    'P2R – qualify image'
)
...
rep(
    ...
    '''          <ul style="list-style:none;padding:0;margin:0;">
            <li style="padding:5px 10px;margin-bottom:4px;background:var(--teal-lt);border-radius:5px;font-size:8.5pt;font-weight:700;color:var(--teal-dk);border-left:3px solid var(--teal);" contenteditable="true">Medicare</li>
            <li style="padding:5px 10px;margin-bottom:4px;background:var(--teal-lt);border-radius:5px;font-size:8.5pt;font-weight:700;color:var(--teal-dk);border-left:3px solid var(--teal);" contenteditable="true">United Health Care &ndash; PPO</li>
            <li style="padding:5px 10px;margin-bottom:4px;background:var(--teal-lt);border-radius:5px;font-size:8.5pt;font-weight:700;color:var(--teal-dk);border-left:3px solid var(--teal);" contenteditable="true">Blue Cross Blue Shield</li>
          </ul>''',
    'P2R – ins pills'
)
...
print(f'\nDone — {changes} replacements applied. File length: {len(c)}')
